...
description: I'll show you 7 personal recommendations to become a high-level software engineer/architect. they personal but hopefully might apply to you too.
date: 2021-07-12
...
toc:
  ...
  - { id: cs-fundamentals, text: "Study the CS Fundamentals" }
  - { id: soft-skills, text: "Improve Soft Skills and Communication" }
  - { id: english, text: "Be a Fluent English Speaker" }
  - { id: expertise, text: "Become an Expert in a Specific Field" }
  - { id: big-picture, text: "Understand the Big Picture" }
  - { id: learning, text: "Never Stop Learning" }
...
<h2 id="certification">1. Get a Certification</h2>
...
<h2 id="cs-fundamentals">2. Study the CS Fundamentals</h2>
...
<h2 id="soft-skills">3. Improve Soft Skills and Communication</h2>
...
<h2 id="english">4. Be a Fluent English Speaker</h2>
...
<h2 id="expertise">5. Become an Expert in a Specific Field</h2>
...
<h2 id="big-picture">6. Understand the Big Picture</h2>
...
<h2 id="learning">7. Never Stop Learning</h2>
